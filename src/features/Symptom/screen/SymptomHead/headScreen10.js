...
import { HEAD_SCREEN11, SYMPTOM_SCREEN } from "../../router";
...
class headScreen10 extends React.PureComponent {
    constructor(){
        super();
        this.state = {
            editing: true,
                            ...
                            <View style={{flexDirection: 'row',
                                ...
                                <TouchableOpacity
                                    ...
                                    onPress={ () => {
                                        ...
                                        this.props.navigation.navigate({routeName: HEAD_SCREEN11, params: { title: `${title}, มีเสมหะ` }});
                                    }}
                                >
                                ...
                                <TouchableOpacity
                                    ...
                                    onPress={ () => {
                                        ...
                                        this.props.navigation.navigate({routeName: HEAD_SCREEN11, params: { title: `${title}, คัดจมูก` }});
                                    }}
                                >
                                ...
                                <TouchableOpacity
                                    ...
                                    onPress={ () => {
                                        ...
                                        this.props.navigation.navigate({routeName: HEAD_SCREEN11, params: { title: `${title}, จาม` }});
                                    }}
                                >
                            ...
                            <View style={{flexDirection: 'row',
                                ...
                                <TouchableOpacity
                                    ...
                                    onPress={ () => {
                                        ...
                                        this.props.navigation.navigate({routeName: HEAD_SCREEN11, params: { title: `${title}, น้ำมูก` }});
                                    }}
                                >
...
headScreen10.navigationOptions  = ({navigation}) => ({
